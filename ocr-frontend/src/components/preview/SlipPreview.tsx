...
const printStyles = `
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  /* ── Top accent bar ───────────────────────────── */
  .accent-bar { height: 6px; background: linear-gradient(90deg, #0F70B7 0%, #23A849 100%); border-radius: 3px 3px 0 0; }

  /* ── Header ───────────────────────────────────── */
  .slip-header { display: flex; justify-content: space-between; align-items: flex-start; padding: 20px 24px 16px; border: 1px solid #e2e8f0; border-top: none; background: #f8fafc; }
  .company-block { display: flex; align-items: flex-start; gap: 14px; }
  .company-logo { height: 48px; width: auto; object-fit: contain; }
  .company-name { font-family: 'Plus Jakarta Sans', 'Segoe UI', sans-serif; font-size: 20px; font-weight: 700; color: #0f172a; letter-spacing: -0.01em; }
  .company-meta { font-size: 11px; color: #64748b; line-height: 1.5; margin-top: 2px; }
  .company-gst { font-family: 'JetBrains Mono', 'Consolas', monospace; font-size: 11px; color: #475569; letter-spacing: 0.02em; }

  .doc-badge { text-align: right; }
  .doc-type { display: inline-block; font-size: 10px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.1em; color: #fff; background: #0F70B7; padding: 3px 10px; border-radius: 3px; }
  .doc-id { font-family: 'JetBrains Mono', 'Consolas', monospace; font-size: 15px; font-weight: 600; color: #0F70B7; margin-top: 6px; }
