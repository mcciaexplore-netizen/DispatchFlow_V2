...
import database
import models
from routers import auth as auth_router, dispatches as dispatches_router
...
async def lifespan(app: FastAPI):
    """Load PaddleOCR models on startup and init db."""
...
app.include_router(dispatches_router.router)
